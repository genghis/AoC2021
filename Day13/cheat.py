#I pulled down someone else's solution here so I could make sure my solution was actually wrong, not just readable. Will not submit until mine actually works.

coords, folds = open('input13.txt').read().split('\n\n')
